...
<head>
  ...
  <link rel="stylesheet" href="{{asset('assets/student_front/css/jquery-ui.css')}}">
  ...
  <link rel="stylesheet" href="{{asset('assets/student_front/css/jquery.fancybox.min.css')}}">
...
@include('web_front.footer')
  ...
  <script src="{{asset('assets/student_front/js/jquery-3.3.1.min.js')}}"></script>
  <script src="{{asset('assets/student_front/js/jquery-migrate-3.0.1.min.js')}}"></script>
  <script src="{{asset('assets/student_front/js/jquery-ui.js')}}"></script>
  ...
  <script src="{{asset('assets/student_front/js/jquery.fancybox.min.js')}}"></script>
