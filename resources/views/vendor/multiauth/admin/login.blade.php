                  ...
                  <div class="card-body p-4">
                    <div class="row flex-between-center">
                      <div class="col-auto pt-3">
                        ...
                        <span class="mb-0 fw-semi-bold">Are you a Student?</span> <span><a href="{{ route('student.login') }}"><b>Sign In Here</b></a></span>
                      </div>
                    </div>
                    <form method="POST" action="{{ route('admin.login') }}" aria-label="{{ __('Admin Login') }}">
                      ...
                      <div class="row flex-between-center">
                        ...
                        <div class="col-auto"><a class="fs--1" href="{{ route('admin.password.request') }}"><b>Forgot Password?</b></a></div>
                      </div>
