      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-6 col-lg-3">
            <a href="{{url('/')}}">
              <img src="{{asset('assets/student_front/images/logo.png')}}" style="max-height:100px" alt="Image" class="img-fluid">
...
<!--               <div class="icon align-self-start">
          ...
          <div class="col-lg-3 d-none d-lg-block">
            <div class="quick-contact-icons d-flex">
              <div class="text">
<img src="{{asset('assets/student_front/images/logo2.png')}}" style="max-height:100px" alt="Image" class="img-fluid">
              </div>
            </div>
          </div>